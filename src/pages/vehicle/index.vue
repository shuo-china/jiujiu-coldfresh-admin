<template>
  <page>
    ...
    <pro-table ref="tableRef" :request="getVehiclePaginationApi">
      <el-table-column label="车牌号" prop="plate_num" />
...
import { deleteVehicleApi, getVehiclePaginationApi } from "@/api/vehicle";
